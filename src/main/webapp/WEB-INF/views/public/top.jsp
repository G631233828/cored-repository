      ...
      <div class="navbar navbar-fixed-top scroll-hide">
        <div class="container-fluid top-bar">
			...
			<!--
              <li class="dropdown messages hidden-xs">
               ...
               <li class="dropdown user hidden-xs"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img width="34" height="34" src="${pageContext.request.contextPath}/assets/images/avatar-male.jpg" />
                 ${sessionScope.usr_auth.username}<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a class="list-group-item" href="${pageContext.request.contextPath}/personalfile/getPersionalRecord">
                    <i class="icon-user"></i>时光轴</a>
                  </li>
                  <li> <a class="list-group-item " href="${pageContext.request.contextPath}/user/personalData">
          ...
          <div class="text-center" style="float:left;padding-top: 5px;">
          	<h3>
          	<span style="color: red;"><strong>中赤</strong></span> <span style="font-size: 15px;">全媒体资源中心</span>
          ...
          <div class="nav-collapse">
            <ul class="nav">
              ...
              <a data-toggle="dropdown" href="${pageContext.request.contextPath}/resourcesCenter/center">
                ...
                <ul class="dropdown-menu">
                 <li>
                    <a href="${pageContext.request.contextPath}/resourcesCenter/center?&resourcesType=ALL&sortCol=uploadTimeASE">全部</a>
                  </li>
                  <li>
                    <a href="${pageContext.request.contextPath}/resourcesCenter/center?resourcesType=video&sortCol=uploadTimeASE">视频</a>
                  </li>
                  <li>
                     <a href="${pageContext.request.contextPath}/resourcesCenter/center?resourcesType=document&sortCol=uploadTimeASE">文档</a>
                  </li>
                  <li>
                  <a href="${pageContext.request.contextPath}/resourcesCenter/center?resourcesType=picture&sortCol=uploadTimeASE">
                    <span class="notifications label label-warning">图片</span>
                    <p>图片</p></a>
                    
                  </li>
                  <li>
                   <a href="${pageContext.request.contextPath}/resourcesCenter/center?pageNo=1&resourcesType=music&sortCol=uploadTimeASE">音频</a>
                  </li>
                  <li>
                     <a href="${pageContext.request.contextPath}/resourcesCenter/center?pageNo=1&resourcesType=other&sortCol=uploadTimeASE">其他</a>
                  </li>
					...
					<c:if test="${sessionScope.usr_auth.type =='SCHOOLMANAGER'}">
						...
						<li class="dropdown"><a data-toggle="dropdown" href="#">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="${pageContext.request.contextPath}/resourcesType/list">类型配置</a></li>
								<li><a href="${pageContext.request.contextPath}/list">用户管理</a></li>
								<li><a href="${pageContext.request.contextPath}/resources/list"><div class="notifications label label-warning">管理</div>资源中心 </a></li>
