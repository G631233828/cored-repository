                    ...
                    <tr>
                      ...
                      <td class="actions">
                        <div class="action-buttons">
                         <a class="table-actions" href="${ctx}/resourcesCenter/getResourceDetail?resourceId=${items.id}">
                         <i class="icon-eye-open" title="查看资源详细"></i></a>
                        
                           <a class="fancybox" href="#fancybox-example-update" 
                           onclick="update('${items.id}','${items.rolePermissions}','${items.name }')" title="审核资源">
...
<!-- 更新－弹出层 -->
   ...
   <!-- 删除与批量删除 -->
    ...
    <script type="text/javascript">
    	function update(id,rolePermissions,name){
			$("#update_id").val(id);
