...
<body>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="widget-container fluid-height clearfix">
						<div class="heading">
							<i class="icon-table"></i>基本信息管理 <a
								class="btn btn-sm btn-primary-outline pull-right fancybox"
								href="#fancybox-example"> <i></i>添加
							</a>
						</div>
						...
						<div class="widget-content padded clearfix">
							<table class="table table-bordered table-striped" id="dataTable1">
								...
								<tbody>
									<c:forEach items="${pageList.datas}" var="items"
										...
										<tr>
											...
											<td class="hidden-xs">${items.username }</td>
											<td class="hidden-xs">${items.email }</td>
                       		...
                       		其他类型
											...
											<td class="hidden-xs">${items.remark }</td>
											<td class="actions">
												<div class="action-buttons">
													...
													</a> <a class="fancybox" href="#fancybox-example-delete"
														onclick="deletes('${items.id}')"> <i
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="firstname">姓名</label><input class="form-control"
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label for="type">角色</label> <select class="select2able"
								name="type" id="type"> 
								<option value="">请选择角色</option>
								<c:if test="${sessionScope.usr_auth.type == 'SUPERMANAGER'}"><option value="SUPERMANAGER">超级管理员</option></c:if>
								<option value="SCHOOLMANAGER">学校管理员</option>
								<option value="TEACHERUSER">教师</option>
							</select>
							<!--  <input class="form-control" id="lastname" name="" type="text"> -->
						</div>
						<div class="form-group">
							<label for="confirm_password">密码确认</label><input
								class="form-control" id="confirm_password" name=""
								type="password">
						</div>
					</div>
				</div>
			...
			<fieldset>
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="firstname">姓名</label><input class="form-control"
								id="update_name" name="name" type="text">
						</div>
						<div class="form-group">
							<label for="username">用户名</label><input class="form-control"
								id="update_username" name="username" type="text">
						</div>
						<div class="form-group">
							<label for="password">密码</label><input class="form-control"
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label for="email">邮箱</label><input class="form-control"
								id="update_email" name="email" type="email">
						</div>
						<!--                 <div class="form-group"> -->
						<label for="lastname">资源权限</label><input class="form-control"
							id="update_id" name="id" type="hidden">
						<!--                 </div> -->
						<!--                 <div class="form-group"> -->
				...
				<div class="row">
					<div class="form-group">
						<label class="control-label col-md-1">备注</label>
						<div class="col-md-11">
							<textarea id="update_remark" name="remark" class="form-control"
								rows="3"></textarea>
						</div>
					</div>
				</div>
	...
	<div id="fancybox-example-delete" style="display: none">
		<h4>删除提示</h4>
		<div class="row">
			<div class="text-center">您确认要删除吗?删除后将无法恢复数据!</div>
